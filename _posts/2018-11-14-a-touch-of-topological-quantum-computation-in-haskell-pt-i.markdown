...
Two particles that split can only fuse back into themselves. So the definition is pretty trivial. This is like $latex \hat{e}_i \cdot \hat{e}_j = \delta_{ij}$.
