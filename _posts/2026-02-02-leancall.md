...
Maybe _especially_ as a programming language. Got lots of fun doodads, cool compiler to fast code, metaprogramming, and then some day maybe you can prove something if you feel like it. Feel no guilt putting `unsafe` and `partial` everywhere imo. It's the analog of just getting `clone` happy in Rust. Just do it at the first sight of trouble. I absolve you.
