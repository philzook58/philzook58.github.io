...
2. a [lark](https://github.com/lark-parser/lark) parser for lean output. I like lark. It also outputs reaosnable defaults. `none` becomes `None`, `String` is `str`, `Int` and `Nat` are `int`, etc.
