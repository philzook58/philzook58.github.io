...
Maybe _especially_ as a programming language. Got lots of fun doodads, cool compiler to fast code, metaprogramming, and then some day maybe you can prove something if you feel like it as a treat.
...
This is done by basically 4 things:
...
<video src="/pynb/2026-02-02-leancall_files/cartpole.mp4" autoplay loop muted controls> </video>
...
Here's a Lean version of basically the same. I wrote it in an imperative style to match the above. Probably a better thing to do is use `Array.ofFn` <https://lean-lang.org/doc/reference/latest/Basic-Types/Arrays/#Array___ofFn>
