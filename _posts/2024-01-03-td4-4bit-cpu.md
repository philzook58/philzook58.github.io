...
plus the [schematics](https://github.com/wuxx/TD4-4BIT-CPU/blob/master/doc/cpu_td4.jpg) didn't make this conceptually too hard.

![Schematics](/assets/td4/cpu_td4.jpg)

 Figuring out the directionality of the surface mount diodes gave us pause, but we used a diode tester functionality in our multimeter to figure it out. The tiny green line on the _front_ of the diode is towards the bottom of the board. I believe the line was on the _back_ of the diode was towards the top, but it is soldered down now so I can't check.
