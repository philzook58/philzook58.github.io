...
---
 ...
 In a previous post <https://www.philipzucker.com/frozenset_dtt/> , I tried to write python code on frozensets that in some way demonstrates the set semantics of dependent types. This is a slight but important change I wanted to do based on my new appreciation of the centrality of the concept of "family", a set valued function. _Everything_ should be a family (a dict with set values). The counterintuitive part is that seemingly pointless `()` keys clean things up.

# Judgements Should Interpret as Mappings
