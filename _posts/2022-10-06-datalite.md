...
date: 2022-10-03
layout: post
title: "A Simple Datalog Built Around SQLite in Python"
...
All in all, let's say that datalite has a 5x slowdown on this particular example (it is not at all clear that this example is indicative of common datalog workloads, but it is what it is.). I'll take it. I started at 40x.
