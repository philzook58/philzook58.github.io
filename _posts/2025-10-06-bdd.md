...
The basic interesting thing is `liftA2` / `map2`. It checks on the variable ordering and recurses. If they are equal it kind of zips. If they aren't equal it recurses apart the one with the bigger variable.
