...
; really gums up the works. Maybe a matching loop, associating and reassocating?
; or is it it's interfernece with otimes the object veriosn.
; There are some really bad patterns being inferred.
;(assert (forall ((A Gat)
;         (B Gat)
 ;        (C Gat)
  ;       (X Gat)
