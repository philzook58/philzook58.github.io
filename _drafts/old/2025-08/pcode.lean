...
-- https://github.com/philzook58/knuckledragger/blob/main/kdrag/contrib/pcode/__init__.py
...
inductive OpCode where
  | IMARK | COPY | LOAD | STORE | BRANCH | CBRANCH | BRANCHIND | CALL | CALLIND
  | CALLOTHER | RETURN | INT_EQUAL | INT_NOTEQUAL | INT_SLESS | INT_SLESSEQUAL
  ...
  | INT_RIGHT | INT_SRIGHT | INT_MULT | INT_DIV | INT_SDIV | INT_REM | INT_SREM
  ...
  | FLOAT_TRUNC | FLOAT_CEIL | FLOAT_FLOOR | FLOAT_ROUND
...
structure PcodeOp where
  inputs : Array Varnode
  outputs : Array Varnode
  opcode : OpCode
  deriving Inhabited, BEq, Repr
